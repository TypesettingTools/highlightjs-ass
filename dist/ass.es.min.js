...
;return a=>{var c={begin:/{/,end:/}|$/,scope:"punctuation",contains:[{
...
case_insensitive:!0,contains:[c,{begin:/^Dialogue: /,beginScope:"attr",end:/$/,
contains:[{begin:/\d*,\d+:\d\d:\d\d.\d+,\d+:\d\d:\d\d.\d+,/,
end:a.regex.lookahead(/,/),excludeBegin:!0,scope:"symbol"},c]},{scope:"section",
